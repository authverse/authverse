...
export function CodeBlock({
  ...
  return (
    <figure
      ...
      {...props}
      className={cn(
        isTab ? [bg, "rounded-lg"] : "my-4 rounded-lg",
    ...
    >
      {title ? (
        <div
          className={cn(
            "group flex text-fd-muted-foreground items-center gap-2 ps-3 h-9.5 pr-1",
            isTab && "border-b"
          )}
        >
          {typeof icon === "string" ? (
...
export function CodeBlockTabs({ ref, ...props }: ComponentProps<typeof Tabs>) {
  ...
  return (
    <Tabs
      ...
      {...props}
      className={cn(
        "p-1 rounded-xl border overflow-hidden",
        !nested && "my-4",
        props.className
      )}
    >
...
export function CodeBlockTabsList(props: ComponentProps<typeof TabsList>) {
  return (
    <TabsList
      {...props}
      className={cn(
        "flex flex-row overflow-x-auto px-1 -mx-1",
        props.className
      )}
    >
      {props.children}
