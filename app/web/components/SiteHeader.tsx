...
const SiteHeader = () => {
  ...
  return (
    <div className="fixed w-full h-14 z-50 px-6 lg:px-16 mx-auto top-0 left-0 right-0 bg-white dark:bg-black border-b border-stone-200 dark:border-stone-800">
